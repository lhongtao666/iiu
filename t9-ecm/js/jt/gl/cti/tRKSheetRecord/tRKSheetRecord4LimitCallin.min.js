...
a.append("</div>");a.append("</div>");a.append("</div>");a.append('<div class="col-sm-6">');a.append('<label class="col-sm-2 control-label">去重</label>');
...
a.append("</div>");a.append("<div class='col-sm-9'>");a.append('<button type="button" class="jt-btn jt-btn-search insideLineSheetRecordSearch" style="margin-right:10px;margin-left:4px;"><i class="fa fa-search"></i>&nbsp;搜索</button>');
a.append('<button type="button" class="jt-btn jt-btn-empty assignBtn"><i class="fa fa-trash-o"></i>&nbsp;清洗</button>');a.append('<label id="glHelpContainer"></label>');
a.append("</div>");a.append("</div>");a.append("</div>");a.append("</div>");a.append("</form>");$("#insideLineSheetRecordSearchForm").replaceWith(a.toString());
},_locateToGlHelp:function(){var a="glHelp.runtime.trkSheetRecordSpreadRecord";glHelpUtil.init(a);},_hideNotGrantBtn:function(){if(!ResUtils.canShow("trkSheetRecord_limitCallin.button.assign")){$("button.assignBtn").hide();
...
var m=new StringBuffer();if(ResUtils.canShow("trkSheetRecord_limitCallin.button.listen")){m.append("<button title='调取录音' uniqueCode='"+j+"'   id-value ='"+i.id+"'  recfileVal='"+l+"' class='listenBtn jt-btn-safe'><i class='fa fa-caret-square-o-left' ></i></button>&nbsp;&nbsp;");
}if(ResUtils.canShow("trkSheetRecord_limitCallin.button.download")){m.append("<button title='下载录音' uniqueCode='"+j+"'   id-value ='"+i.id+"'  recfileVal='"+l+"' class='downloadBtn jt-btn-safe'><i class='fa fa-download'></i></button>&nbsp;&nbsp;");
}if(ResUtils.canShow("trkSheetRecord_limitCallin.button.delete")){m.append("<button title='删除录音' uniqueCode='"+j+"'  id-value ='"+i.id+"'  recfileVal='"+l+"' class='deleteBtn jt-btn-error'><i class='fa fa-remove'></i></button>&nbsp;&nbsp;");
}if(ResUtils.canShow("trkSheetRecord_limitCallin.button.operateRecordMark")){m.append("<button title='通话标识' uniqueCode='"+j+"' id-value ='"+i.id+"' recfileVal='"+l+"' class='operateRecordMarkBtn jt-btn-safe'><i class='fa fa-bookmark'></i></button>&nbsp;&nbsp;");
}if(ResUtils.canShow("trkSheetRecord_limitCallin.button.operateRecordRecomm")){m.append("<button title='录音推荐' uniqueCode='"+j+"' id-value ='"+i.id+"' recfileVal='"+l+"' class='operateRecordShareBtn jt-btn-safe'><i class='fa fa-thumbs-o-up'></i></button>&nbsp;&nbsp;");
}if(ResUtils.canShow("trkSheetRecord_limitCallin.button.operateRecordHi")){m.append("<button title='操作记录' uniqueCode='"+j+"' id-value ='"+i.id+"' recfileVal='"+l+"' class='operateRecordHiBtn jt-btn-safe'><i class='fa fa-list'></i></button>&nbsp;&nbsp;");
