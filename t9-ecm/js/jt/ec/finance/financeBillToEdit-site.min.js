...
c.chosen();}else{c.select2();}},null,true);},};$(function(){var a=new FinanceBillToEdit();a.init();});function FinanceBillToEdit(){isPoint=false;this.soEntityBase=new SoEntityBase();
this.financeBillBase=new FinanceBillBase();this.csFollow=new CsFollow();}FinanceBillToEdit._CONS_={SO_SAVE_PAY_URL:ctx+"/ec/salesorder/soEntity/soSaveEdit.htm",LIST_DATA_URL:ctx+"/ec/finance/financeBill/listData.htm",EDIT_URL:ctx+"/ec/finance/financeBill/edit.htm",EDIT_FORM_ID:"financeBillForm",};
...
DialogUtils.error(msgCode.ERROR,msgCode.ERROR_MSG);});}};var FinanceAccountSelect={initSelect:function(c,b,a){$.ajax({type:"GET",url:ctx+"/ec/finance/financeAcount/listPo.htm",contentType:"application/x-www-form-urlencoded",dataType:"json",success:function(f){if(f!=null&&f!=""){var d=document.getElementById(c);
