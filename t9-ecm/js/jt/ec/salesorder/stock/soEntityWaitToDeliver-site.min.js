...
c.chosen();}else{c.select2();}},null,true);},};$(function(){var a=new SoEntityWaitToDeliver();a.init();});function SoEntityWaitToDeliver(){this.soEntityBase=new SoEntityBase();
}SoEntityWaitToDeliver._CONS_={PACK_FORM_ID:"#soEntityPackForm",SAVE_DELIVER_URL:ctx+"/ec/salesorder/soEntity/saveDeliver.htm",PACK_URL:ctx+"/ec/salesorder/soEntity/pack.htm",SO_SAVE_COMFIRM_URL:ctx+"/ec/salesorder/soEntity/soSaveEdit.htm",};
