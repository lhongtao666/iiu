...
},};$(function(){var a=new UploadImageUtil();a.init();});function UploadImageUtil(){this.userId=currentUserId;this.contentId="uploader";this.images=[];
}UploadImageUtil._CONS_={SAVE_ADD_URL:ctx+"/gl/image/image/saveAdd.htm",UPLOAD_PARAMS:{"acceptTypes":"gif,jpg,jpeg,bmp,png","mimeTypes":"image/*","fileSingleSizeLimit":1*1024*1024*6,"fileNumLimit":10,"uploadUrl":ctx+"/crm/components/upload/ajax.htm?categoryDir=temp"}};
...
}d.empty().append(e.toString());}}};$(function(){var a=new SoEntityQueryLogistics();a.init();});function SoEntityQueryLogistics(){}SoEntityQueryLogistics._CONS_={SHIP_INFO_QRY_URL:ctx+"/ec/salesorder/soEntity/logicsByNo.htm",};
