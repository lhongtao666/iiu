$(function(){function b(){this.hadInit=false;this.isEdit=false;this.intervalId=null;this.time=0;this.$container=$('div[srcVal="/ec/salesorder/soEntity/desktop/todayComfirmInfo.htm"]');
...
b.prototype={init:function(d){var c=this;if(!c.hadInit){c.hadInit=true;c._refreshChart();}},_refreshChart:function(){var c=this;$.ajax({type:"GET",url:b._CONS_.INDEX_URL,data:"stausType=audit&timeType=day",contentType:"application/json",dataType:"json",success:function(d){if(d.count=="0"){c.$container.find(b._CONS_.INFO_SHOW_ELEMENT).html(d.count+"/"+parseFloat(d.totalAmount).toFixed(0));
...
setTimeout(function(){c._refreshChart();},10*60000);clearInterval(c.intervalId);c.intervalId=setInterval(function(){c.time=c.time+1;c.$container.find(b._CONS_.REFRESH_TIME_ELEMENT).html(c.time);
