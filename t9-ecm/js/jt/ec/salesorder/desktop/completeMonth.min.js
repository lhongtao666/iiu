$(function(){function b(){this.hadInit=false;this.isEdit=false;this.intervalId=null;this.time=0;this.$container=$('div[srcVal="/ec/salesorder/soEntity/desktop/monthCompleteInfo.htm"]');
...
b.prototype={init:function(d){var c=this;if(!c.hadInit){c.hadInit=true;c._refreshChart();}},_refreshChart:function(){var c=this;$.ajax({type:"GET",url:b._CONS_.INDEX_URL,data:"stausType=sign&timeType=month",contentType:"application/json",dataType:"json",success:function(d){if(d.isUp=="n"){c.$container.find(b._CONS_.INFO_SHOW_ELEMENT).html(d.count+"/"+parseFloat(d.totalAmount).toFixed(0));
