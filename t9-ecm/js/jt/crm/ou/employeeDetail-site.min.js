...
FormUtils.bindFormValidation(UserPw._CONS_.FORM_ID,b);}};var PositionUtils={loadPositionOptions:function(a){a.url=ctx+"/gl/ou/position/findAllPosition.htm",a.caption="请选择岗位";
return OptionsBaseUtils.getOptions(a);},clearPositionCache:function(a){var b=ctx+"/gl/ou/position/findAllPosition.htm";window.sessionStorage.removeItem(b);
},};function SeniorSearch(){this.hadInit=false;this.hadInitClik=false;this.treeNodeName="";}SeniorSearch.prototype={init:function(){if(!this.hadInit){this.hadInit=true;
...
}else{return d(f.getParentNode())+"<i class='fa fa-angle-right'></i>"+"<span class='jt-blue' id-value='"+f.id+"'>"+f.name+"</span>";}}},};