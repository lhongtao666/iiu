var ReportDateUtil={initDate:function(f,e){e=e||$(document);var a=new Date();var c=a.getFullYear();var d=new StringBuffer();for(var b=2010;b<=c;b++){d.append("<option value='").append(b).append("' >").append(b).append("年</option>");
