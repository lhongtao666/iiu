...
var gr_InstallPath = ctx+"/plugins/gridReport"; //实际项目中应该写从根目录寻址的目录，如gr_InstallPath="/myapp/report/grinstall"; 
...
function loadTpl(loadTplUrl,reportParentObj,func){
	  $.ajax({
			type : "POST", 
			url : loadTplUrl, 
			...
			success : function(file) {
				reportParentObj.Report.LoadFromStr(file);
				reportParentObj.Reload();
				if(func){
					func();
				}
			},
