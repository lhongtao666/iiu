...
function Install_InsertReport()
{
	...
	document.write(' width="0" height="0"  vspace="0" hspace="0" VIEWASTEXT>');
		 ...
		 var _ReportOK = document.getElementById("_ReportOK");
		    if (_ReportOK.Register == undefined) //if ((_ReportOK == null) || (_ReportOK.Register == undefined))
		    {
		        document.write('<div style="width: 100%; background-color: #fff8dc; text-align: center; vertical-align: middle; line-height: 20pt; padding-bottom: 12px; padding-top: 12px;">');
		            document.write('<strong> 此网站需要安装 打印插件 才能保证其正常运行<br /></strong>');
		            
		        if( _gr_isIE )
		            document.write('<strong><span style="color: #ff0000"> 如浏览器的顶部或底部出现提示条，左键点击提示条并运行加载项，按此方式安装最简便</span><br /></strong>');
		            
		            document.write('<a href="' + gr_InstallPath + '/grbsctl6.exe"><span style="color: #ff0000"><strong>点击此处下载打印插件安装包<br /></strong></span></a>');
		            document.write('打印插件安装后，<a href="#" onclick="javascript:document.location.reload();">点击此处</a> 重新加载此网站');
		        document.write('</div>');
		        return false;
		    }
		    ...
		    {
		        document.write('<div style="width: 100%; background-color: #fff8dc; text-align: center; vertical-align: middle; line-height: 20pt; padding-bottom: 12px; padding-top: 12px;">');
		            document.write('<strong> 此网站需要升级安装 打印插件 才能保证其正常运行<br /></strong>');
		            document.write('<a href="' + gr_InstallPath + '/grbsctl6.exe"><span style="color: #ff0000"><strong>点击此处下载打印插件安装包<br /></strong></span></a>');
