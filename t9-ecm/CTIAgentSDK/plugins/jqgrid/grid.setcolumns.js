...
$.jgrid.extend({
	setColumns : function(p) {
		p = $.extend({
			...
			closeicon: [true,"left","UI theme roller"],
			onClose : null,
			colnameview : true,
		...
		return this.each(function(){
			...
			if ( $("#"+IDs.themodal).html() != null ) {
				...
				formdata += "<table class='ColTable' cellspacing='1' cellpading='2' border='0'><thead><tr><td><input type='checkbox' id='cekAll'>全选</td></tr></thead><tbody>";
				...
				$("#cekAll").click(function(){
					var flag = this.checked;
					 $(".cbox").each(function () {//查找每一个Id以Item结尾的checkbox
